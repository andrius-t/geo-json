...
const buttonType = {
  ...
  outlineBlue: 'whitespace-nowrap inline-flex items-center rounded-md border border-transparent border-blue-600 px-4 py-2 text-base font-medium text-blue-900 shadow-sm hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2'
};

type Props = {
  buttonColor?: "blue" | "green" | "outlineBlue";
}
